...
- every dot on the grid. Instead of using breadth first 
- search to find the path, this version uses Dijkstra's 
- algorithm to pathfind. A dot-dot connection is 1 weight, 
- dot-empty is 2, and empty-empty is 3.
